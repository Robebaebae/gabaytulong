...
$_SESSION['currentPage_1'] = 1;


    if(isset($_GET["page"]))
        {
            $page=$_GET["page"];
      		$_SESSION['currentPage_1'] = $page;
        }
    else
        {
            $page=1;
...
<h1>ORGANZATION PROCESSED REQUESTS</h1>
<div class="dashboard-organization-details-content">

            <div class="fillup-input-group"> 
                      <input  required  class="fillup-field" type="text" name="search_text" id="search_text">
...
$(document).ready(function(){ 
  ...
  $("#fetchval").on('change',function(){
    var value = $(this).val();
    $.ajax({
    url:"../functions/orgProcessedRequestSearch.php",
    method:"POST",
    data: 'request='+ value,
