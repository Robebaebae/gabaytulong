...
if($currentorg_status==0){
    $currentorg_statusText = "Inactive";
}
if($currentorg_status==1){
    $currentorg_statusText = "Active";
}
...
,'org_details' => '','org_contact' => '','org_adminEmail' => '','org_dp' => '');
        ...
        if(array_filter($errors)){
            ...
            $query = "UPDATE organizations SET org_name='$org_name',org_address='$org_address',org_details='$org_details',
            org_contact='$org_contact',org_admin='$org_admin',org_adminEmail='$org_adminEmail' WHERE org_id='$org_UpdateID'"; 
           
            if(mysqli_query($conn, $query)){
                // success
                header('Location: ../OrganizationView/OrganizationReport.php');
                mysqli_close($conn);
            } else {
