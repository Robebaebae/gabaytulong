...
if(isset($_POST["query"]))
{
 ...
 $query = "
  ...
  WHERE (req_archive='ARCHIVED'  AND requests.org_id = '".$_SESSION["currentOrg"]."')
...
else if(isset($_POST["request"]))
{
 if($_POST["request"]=="All"){
    ...
    requests.asst_id = assistance_offered.asst_id WHERE req_archive='ARCHIVED'  AND requests.org_id = '".$_SESSION["currentOrg"]."' ORDER BY req_date
    ";
 }
 else{
...
<form action="../functions/orgAsstUnarchive.php" method="POST">
  ...
  $output .= '
                ...
                <tbody>   
                        <tr>
                                        ...
                                        <td class="column3" onClick='.$clickLink.'>'.$row["req_givenname"].' '.$row["req_middlename"].' '.$row["req_lastname"].'</td>
                                        <td class="column4" onClick='.$clickLink.'>'.$row["req_email"].'</td>
                                        <td class="column5" onClick='.$clickLink.'>'.$row["asst_name"].'</td>
                                        '.$req_status.'
                        </tr>
                </tbody>
 ...
 <button  style="float:right;position:relative; " type="submit" name="stud_archive_btn" class="button-quatary unarchived">
 <object data="../resources/assets/icons/unarchive.svg" width="24" height="24"></object>Unarchive
 </button>
 </form>
 ...
 $i = 1;
 $nextI= $_SESSION['currentPage_2'] + 1;
 $backI= $_SESSION['currentPage_2'] - 1;

          if($_SESSION['currentPage_2'] == 1){
           if($total_pages == 1){
            $output .= '
               
               <li class="page-item"><a class="page-link" 
               style="background-color:hsl(218, 72%, 18%);color:white;" href="OrganizationArchivedRequest.php?page='.$_SESSION['currentPage_2'].'">'.$_SESSION['currentPage_2'].'</a></li>
           ...
           $output .= '
               ...
               <li class="page-item"><a class="page-link"href="OrganizationArchivedRequest.php?page='.$nextI.'">></a></li>
               
               <li class="page-item"><a class="page-link"href="OrganizationArchivedRequest.php?page='.$total_pages.'">>></a></li>
            
               ';
          }
          }
  		  else if($_SESSION['currentPage_2'] == $total_pages){
          $output .= '
          	<li class="page-item"><a class="page-link"href="OrganizationArchivedRequest.php?page=1"><<</a></li>
          
               <li class="page-item"><a class="page-link"href="OrganizationArchivedRequest.php?page='.$backI.'"><</a></li>
