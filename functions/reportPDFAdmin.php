...
$result = mysqli_query($conn, $_SESSION['newQueryAdmin']);
...
while($row = mysqli_fetch_array($result))
 {
  ...
  $data .= '
    ...
    <tr id="tableContent">
        <td id="contentTD" >'.$row["org_id"].'</td>
        <td id="contentTD" >'.$row["org_name"].'</td>
        <td id="contentTD" >'.$row["org_admin"].'</td>
        <td id="contentTD" >'.$row["org_adminEmail"].'</td>
        <td id="contentTD" >'.$row["org_status"].'</td>
    </tr>
...
<div id="footer">
<h1 style="text-align:right; margin-top:5%; font-style: italic;">Super Admin</h1><br>
</div>
