...
foreach($current_requestor_details as $current_requestor_detail){
    ...
    function sendmail(){
        ...
        $body =  "Congratulation! After thorough review of your application,
		your organization has been accepted! Here is your generated password, ". $_SESSION["currentorg_adminpassword"];
