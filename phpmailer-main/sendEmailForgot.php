...
foreach($current_requestor_details as $current_requestor_detail){
    ...
    if($current_organization == $_SESSION["currentForgot_orgid"])
    {
    ...
    function sendmail(){
        ...
        $body =  "Your organization's password has been reset! Here is your new generated password, ". $_SESSION["currentorg_adminpassword"];
