...
foreach($current_requestor_details as $current_requestor_detail){
    ...
    function sendmail(){
        ...
        $body =   "We are sorry to inform you but after thorough review of your application
        , your request has been ".$_SESSION["currentreq_Status"].". Remarks: ".$_SESSION["currentreq_remarks"];
